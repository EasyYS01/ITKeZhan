...
<html>
    ...
    <!--中部，主部分-->
    <div id="medium1" style="height: 500px;">

            <div id="cycle1">
				<form action="chuli.php" method="post">
					<input style="width: 500px;height: 40px;font-size: 20px;margin-top:150px;margin-left: 350px; border: 2px solid #4CAF50;"  name ="name" type="text"><button style="background-color: #4CAF50; border: none;color: white;padding: 15px 32px;text-align: center;text-decoration: none;display: inline-block;font-size: 16px;height: 46px;"  type="submit">搜索一下</button>
				</form>
				<div style="margin-top: 100px;" class="dibu layui-col-md12 layui-bg-gray">
					<h1>关于博客</h1>
